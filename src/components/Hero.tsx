  ...
  return (
    <section id="top" className="relative flex min-h-screen w-full max-w-full flex-col overflow-hidden bg-ink text-white">
      ...
      >
        ...
        >
          <span className="block text-[clamp(1.4rem,4.5vw,4.2rem)] font-light leading-tight text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.95)] whitespace-nowrap">
            LATEEF-UL-IL-AKBAR-LI-A’AZAM
          </span>
